...
const Yesterday = () => {
    ...
    const {data, errors_yesterday} = dataa;

    const {timeout_yesterday, zeroes_yesterday, avg_price_yesterday, str_yesterday, ctr_yesterday, bookings_previous_yesterday, searches_previous_yesterday, clicks_previous_yesterday, clicks_current_yesterday, bookings_current_yesterday } = data[0];
    ...
    return (<div className="pagee">
        ...
        <Bar data={errors_yesterday} timeout={timeout_yesterday.toFixed(2)} zeros={zeroes_yesterday.toFixed(2)} errors={data[0].errors_yesterday.toFixed(2)}/>
                        ...
                        <div className="infoE">
                         ...
                         <div className="infoE">
                            <span style={{
                                color: "#A0B0B9",
                                fontSize: 20
                            }}>{clicks_previous_yesterday}</span>
                            <span style={{
                                color:"#A0B0B9"
                            }}>Last</span>
                        </div>
