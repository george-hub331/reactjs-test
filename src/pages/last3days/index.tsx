...
const Last3days = () => {
    const {errors_last_3days, data } = dataa;
    const {bookings_current_last_3days, searches_current_last_3days, zeroes_last_3days, timeout_last_3days, avg_price_last_3days, ctr_last_3days, clicks_previous_last_3days, str_last_3days, clicks_current_last_3days, searches_previous_last_3days } = data[0];

    return (<div className="pagee">

        <Nav />

         <Bar data={errors_last_3days} timeout={timeout_last_3days.toFixed(2)} zeros={zeroes_last_3days.toFixed(2)} errors={data[0].errors_last_3days.toFixed(2)}/>
                ...
                <div className="infoDesc">
                        ...
                        <div className="infoE">
                            <span style={{
                                color: "#4A4A4A",
                                fontSize: 20
                            }}>{searches_current_last_3days}</span>
                            <span style={{
                                color:"#4A4A4A"
                            }}>Last Three Days</span>
                        </div>
                         ...
                         <div className="infoE">
                            <span style={{
                                color: "#A0B0B9",
                                fontSize: 20
                            }}>{searches_previous_last_3days}</span>
                            <span style={{
                                color:"#A0B0B9"
                            }}>Last 3 Days</span>
                        </div>
                ...
                <div className="infoDesc">
                        ...
                        <div className="infoE">
                            <span style={{
                                color: "#4A4A4A",
                                fontSize: 20
                            }}>{clicks_current_last_3days}</span>
                            <span style={{
                                color:"#4A4A4A"
                            }}>Last Three Days</span>
                        </div>
                         ...
                         <div className="infoE">
                            <span style={{
                                color: "#A0B0B9",
                                fontSize: 20
                            }}>{clicks_previous_last_3days}</span>
                            <span style={{
                                color:"#A0B0B9"
                            }}>Last Friday</span>
                        </div>
